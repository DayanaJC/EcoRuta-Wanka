...
```mermaid
flowchart TB
    U[Usuario<br/>Administrador / Operador<br/>Navegador web] -->|HTML, CSS, JS<br/>fetch / REST| FE[FE<br/>Frontend SPA<br/>React 19 + Vite 8]
    FE -->|HTTP /api/v1/*<br/>JSON<br/>proxy dev: 127.0.0.1:8000| BE[BE<br/>Backend API<br/>Python 3.13 + FastAPI 0.141 + Uvicorn]
    BE -->|Firebase Admin SDK<br/>HTTPS/gRPC| DB[DB<br/>Firebase Cloud Firestore<br/>colecciones: vehiculos, pedidos, asignaciones]
